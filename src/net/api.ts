...
export interface GameState {
  ...
  flags: { metSupervisor: boolean; interimDone: boolean; boardDone: boolean; debriefDone: boolean; workDocDone: boolean; execBriefingDone: boolean };
  engagement: {
    phase: string;
...
export const api = {
  ...
  gatekeeperAnswer: (trackId: string, index: number, choice: number) => post("gatekeeper/answer", { trackId, index, choice }),
