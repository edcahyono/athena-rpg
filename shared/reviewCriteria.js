...
export const GATEKEEPER_REVIEW = {
  ...
  product: {
    criteria:
      "PLACEHOLDER — judge as a Deloitte Consumer Products reviewer prepping a junior for the CPO: does it engage real product reality — China-specific design, icon-release quality, competitor product parity with Anta/Li-Ning? Verdict: strong / acceptable / weak.",
  },
};
...
export const REVIEW_CRITERIA = {
  ...
  cfo: {
    criteria:
      "Judge as the CFO against the FY2021-FY2025 benchmarking dataset: real numbers used correctly, revenue quality distinguished from volume; every proposal states cost, payoff horizon, risk, exit. BENCHMARK BAR: our GC EBIT margin fell 39.1%→24.3% in four years (EBIT $3,243m→$1,602m) — a credible 5-year plan must present a margin-recovery TRAJECTORY, benchmarked against adidas GC's rebuild (operating margin 10.1%→22.1% in three years — proof price discipline works in this market) and the domestic peer operating-margin band (Li-Ning ~13%, Xtep ~14%, 361° ~16%, ANTA ~24%; peer mean ~16.8%). METHODOLOGY DISCIPLINE (fail decks that violate it): Nike segment EBIT is pre-corporate-overhead — an upper bound, not apples-to-apples with standalone peers; only EBIT margin and revenue growth are validly benchmarkable for Nike China; any deck quoting Nike-China ROE/ROA/ROIC/net profit/inventory days as fact is quoting figures that DO NOT EXIST in disclosure; ANTA comparisons must use core profit (ex the one-off Amer gain). Discount-tightening proposals must address volume elasticity. Verdict: strong / acceptable / weak.",
  },
  cmo: {
    criteria:
